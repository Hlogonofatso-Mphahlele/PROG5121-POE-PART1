...
public class LoginTest {
   ...
   // Tests for valid and invalid username formats
    ...
    @Test public void testInvalidUsernameFormat(){
        ...
        assertEquals("Username incorrectly formated. Ensure it has an underscore and doesnt have more than 5 charecters", user.checkUserName());
    }
    ...
    public void testValidPasswordFormat() {
        ...
        assertEquals("Password successfully captured.", user.checkPasswordComplexity());
    }
    @Test public void testInvalidPasswordFormat(){
        Login user = new Login("kyl_1!", "password", "+27838968976");
        assertFalse(user.checkPasswordComplexity());
        assertEquals("Password incorrectly formatted. Ensure it has at least 8+ charecters, a capital letter, a number and a special charecter", user.checkPasswordComplexity());
    }
    ...
    public void testValidCellNumberFormat() {
        ...
        assertEquals("Cell phone number successfully added.", user.checkCellPhoneNumber());
    }
    @Test public void testInvalidCellNumberFormat(){
        Login user = new Login("kyl_1", "Ch&&sec@ke99!", "08966553");
        assertFalse(user.checkCellPhoneNumber());
        assertEquals("Cell phone number incorrectly formatted ir doesnt contain the international code. Ensure that the cell number starts with +27 and is followed by 9 numbers.", user.checkUserName());
    }
    ...
    public void testSuccessfulLogin() {
        Login user = new Login("kyl_1", "Ch&&sec@ke99!", "+27838968976" );
        assertTrue(user.loginUser("ky;_1", "Ch&&sec@ke99!"));
